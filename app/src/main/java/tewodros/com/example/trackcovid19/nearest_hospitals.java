...
public class nearest_hospitals extends FragmentActivity implements OnMapReadyCallback,
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googleURL.append("&key="+"AIzaSyASe8SrJ25y6vg5NZJgS6ZynFoA399NqVo");

        Log.d("nearest_hospitals","url="+googleURL.toString());
